package cn.huischool.huixiao.common.widget.widgetofbindbadgeview;
...
public class BadgeView extends TextView {
    ...
    public void setText(CharSequence text, BufferType type) {
        ...
        if (isHideOnNull() && (text.toString().equals("0") || text == null || text.toString()
                .equalsIgnoreCase
                        ("0"))) {
            ...
            LogUtil.d("获得的o标签样式" + text.toString());
        } else {
