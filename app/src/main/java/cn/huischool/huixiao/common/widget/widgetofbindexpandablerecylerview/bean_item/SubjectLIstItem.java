...
public class SubjectLIstItem extends AbstractExpandableAdapterItem {
    private TextView gradeName;
    private ImageView mArrow;
    private SchoolContactsListBean.ResultsBean.SubjectListBean
            subjectListBean;
    ...
    public int getLayoutResId() {
        return R.layout.item_school_contacts_dividedby_subject;
    }
...
* */
    ...
    public void onUpdateViews(Object model, int position) {
        ...
        subjectListBean = (SchoolContactsListBean.ResultsBean.SubjectListBean) model;
        gradeName.setText(subjectListBean.getName());
    }
}