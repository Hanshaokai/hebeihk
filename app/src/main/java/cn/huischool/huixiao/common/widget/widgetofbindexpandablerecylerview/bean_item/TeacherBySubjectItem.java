...
public class TeacherBySubjectItem extends AbstractExpandableAdapterItem implements View.OnClickListener {
    ...
    public void onUpdateViews(Object model, int position) {
        ...
        if (model instanceof SchoolContactsListBean.ResultsBean.SubjectListBean
                .TeacherListBean) {
            SchoolContactsListBean.ResultsBean.SubjectListBean
                    .TeacherListBean teacherListBean = (SchoolContactsListBean.ResultsBean.SubjectListBean
                    .TeacherListBean) model;
            mName.setText(teacherListBean.getRealName());
            LoadBitmapUtils.LoadContactHeadImagview(CustomApplication.customApplication,(String) teacherListBean
