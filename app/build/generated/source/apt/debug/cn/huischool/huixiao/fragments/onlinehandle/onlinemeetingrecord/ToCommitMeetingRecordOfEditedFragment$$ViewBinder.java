...
public class ToCommitMeetingRecordOfEditedFragment$$ViewBinder<T extends ToCommitMeetingRecordOfEditedFragment> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends ToCommitMeetingRecordOfEditedFragment> implements Unbinder {
    private T target;
