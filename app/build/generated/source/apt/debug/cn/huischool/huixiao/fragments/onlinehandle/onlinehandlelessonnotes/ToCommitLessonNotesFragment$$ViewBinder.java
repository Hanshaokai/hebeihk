...
public class ToCommitLessonNotesFragment$$ViewBinder<T extends ToCommitLessonNotesFragment> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends ToCommitLessonNotesFragment> implements Unbinder {
    private T target;
