...
public class ToCommitStudyNotesOfEditedFragment$$ViewBinder<T extends ToCommitStudyNotesOfEditedFragment> implements ViewBinder<T> {
  @Override
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131624475, "field 'nestscrollMeetingrecordNotesTocommit'");
    target.nestscrollMeetingrecordNotesTocommit = finder.castView(view, 2131624475, "field 'nestscrollMeetingrecordNotesTocommit'");
    return unbinder;
  }
  ...
  protected static class InnerUnbinder<T extends ToCommitStudyNotesOfEditedFragment> implements Unbinder {
    private T target;
